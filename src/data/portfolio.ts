...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Built a standalone multi-tenant certification platform for coding assessments. Features multi-runtime code execution (Node, Python, SQL, Dart), 5 question types with auto-grading, and complete test session management. Designed for commercial licensing.',
    impact: [
      'Multi-runtime execution engine (4 languages)',
      '5 question types with semantic auto-grading',
      'Multi-tenant SaaS with organization isolation',
      'Complete test lifecycle: composition → proctoring → analytics',
    ],
    techStack: [
      'React',
      'TypeScript',
    ...
    highlights: [
      ...
      { label: 'Featured Systems', value: '6' },
...
export const techCategories = [
  ...
  {
    name: 'Infrastructure',
    items: ['AWS', 'Docker', 'Cloudflare', 'Datadog', 'GitHub Actions'],
  },
  {
    name: 'Auth & Security',
    items: ['JWT', 'TOTP/MFA', 'OAuth', 'RBAC', 'AES-256-GCM'],
  },
];
