...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Built a certification platform filling the gap between weak multiple-choice tests (W3Schools) and expensive enterprise hiring tools (HackerRank). Real code execution against test cases, meaningful certifications, accessible pricing. Migrated Express → NestJS in 36 hours including full UI redesign.',
    impact: [
      'Load tested to 50+ concurrent users at 240ms avg response',
      'Express → NestJS migration in 36 hours with UI redesign',
      'Multi-runtime execution engine (JS, TS, Python, SQL)',
      'No competitor combines real code execution + meaningful certs + accessible pricing',
    ],
    techStack: [
      'NestJS',
      'TypeScript',
    ...
    highlights: [
      ...
      { label: 'Migration Time', value: '36 hrs' },
