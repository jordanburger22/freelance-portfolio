...
const GitHubContributions = ({ username }: GitHubContributionsProps) => {
  ...
  // Using ghchart.rshah.org to generate contribution graph SVG
  // Format: https://ghchart.rshah.org/{color}/{username}
  // Using your accent color (blue-500) - remove the # from hex
