          ...
          >
            <div className="bg-background border border-border rounded-xl p-6 space-y-4">
              <p className="text-text-secondary leading-relaxed text-lg">
                I went from teaching bootcamp students to building entire production 
                platforms in under two years. Not through shortcuts — through <span className="text-text-primary font-semibold">constraints 
                that forced creative solutions</span>.
              </p>
              
              <p className="text-text-secondary leading-relaxed">
                At <span className="text-accent font-medium">Simply Coding</span>, 
                I built a cloud IDE that works in prison networks. Air-gapped environments. 
                Firewall restrictions that block WebSocket. No terminal access. Replit and 
                CodeSandbox literally cannot function there — I had to solve problems 
                venture-backed companies haven't touched.
              </p>

              <p className="text-text-secondary leading-relaxed">
                At <span className="text-accent font-medium">GunKustom</span>, 
                I built a 2,700-line compatibility engine that encodes mechanical engineering 
                constraints into executable validation logic. No firearms retailer has anything 
                comparable. When I needed a forum ranking algorithm, I invented one from first 
                principles — then discovered I'd arrived at nearly the same solution as Reddit.
              </p>

              <p className="text-text-secondary leading-relaxed">
                Two jobs, four kids, three hours of focused coding time per day. 
                When time is your scarcest resource, every architectural decision has to count.
              </p>
            </div>
            ...
            <div className="bg-background border border-border rounded-xl p-6">
              ...
              <div className="space-y-6">
                {experience.map((exp, index) => (
                  ...
                  >
                    <div className="absolute -left-[9px] top-0 w-4 h-4 bg-surface border-2 border-border group-hover:border-accent rounded-full transition-colors" />
